...
public class TicTacToeField {
	...
	private Player p1, p2; // Ñîáñòâåííî ñàìè èãðîêè , çàäåëêà íà áóäóùåå ÷òî áû ëåã÷å áûëî ââîäèòü
							// ôóíêöèîíàë
	...
	/*
	 * ñîáñâåííî öèêë èãðû ñ ïðîâåðêàìè è âûâîäîì íà êîíñîëü
	 */
	...
	private boolean isWin(int n) {
		...
		// ïðîâåðÿþ ÷òî áûû íå âûøëî íà ãðàíü
		if (n % 2 != 0) {
			return false;
		}
		// ïðîâåðêà ïî äèàãîíàëè
		if (n % 4 == 0) {
